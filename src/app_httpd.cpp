...
static esp_err_t altitude_handler(httpd_req_t *req)
{
    String s(AltitudeSensor::ReadAltitude());
    char buf[32];
...
void startCameraServer()
{
    ...
    httpd_uri_t altitude_uri = {
        .uri = "/altitude",
        .method = HTTP_GET,
        .handler = altitude_handler,
        .user_ctx = NULL
#ifdef CONFIG_HTTPD_WS_SUPPORT
        ,
        .is_websocket = true,
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK)
    {
        ...
        httpd_register_uri_handler(camera_httpd, &altitude_uri);
    }
